...
const { mergeConfigs } = require('../../../utils/config.js')
const userConfig = require('../../../utils/userConfigs.js')
...
export default function (options) {
  ...
  const svelteCfg = mergeConfigs('svelte', _svelteCfg, userConfig)
  ...
  return mergeConfigs('rollup', config, userConfig, { production })
